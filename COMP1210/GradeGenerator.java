   ...
   public class GradeGenerator {
      ...
      public static void main(String[] args) {
         ...
         comp1210Grade = new Grade("Robert");
      	// set activity, quiz, and project averages
         comp1210Grade.setProjectAverage(projAvg);
         comp1210Grade.setLabAverages(actAvg, quizAvg);
      	// set exam scores
         comp1210Grade.setExamScore(0, exam1Score);
         comp1210Grade.setExamScore(1, exam2Score);
         comp1210Grade.setExamScore(2, finalExamScore);
