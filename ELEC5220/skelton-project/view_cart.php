...
include_header('Robertmart - Shopping Cart');
		...
		if($quantity > 0){
			...
			print '<tr>
					...
					<td>
						...
						<form action="" method="post" onsubmit="return updateCartQuantity('.$item_number.', '.$product['quantity_available'].')">
					...
					<td><small>'.$product['brand'].'</small><br /><b><a href="./item.php?item='.$item_number.'">'.$product['name'].'</a></b></td>
