...
echo "<html><head><title>Data in Books3.xml</title></head><body>";
...
function elementEnd($parser, $data) {
	global $temp, $author, $author2, $author3, $title, $genre, $price, $year, $booknumber;
	if($data == "BOOK") {
		...
		echo "Genre: $genre <br>";
		echo "Price: $price <br>";
		echo "<i>$title</i><br> by $author <br>$author2 <br>$author3<br><br>";
	} elseif($data == "TITLE")
		$title = $temp;
	elseif ($data == "AUTHOR") 
		$author = $temp;
